...
import com.github.rdpgame.tweenaccessors.SpriteTween;
...
public class SplashScreen implements Screen{
	...
	public SplashScreen(RDPGame game){
		this.game = game;
	}
	...
	public void render(float delta) {
		...
		splashSprite.setPosition(Gdx.graphics.getWidth()/2 - splashTexture.getWidth()/2, 
